...
public class ExploreGridVm extends BaseObservable {
    ...
    public String getTrailcount() {
        return data.getTrails_count()==0 ? "0" :String.valueOf( data.getTrails_count() );
    }
    ...
    public ExploreGridVm(Data dataModel) {
        this.data = dataModel;
    }
